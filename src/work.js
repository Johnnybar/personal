    ...
    return (<div id='work-section'>
      <div className='work-top'>
        ...
        <div className='work-description'>
          <p>
            <a href='https://imagebunker.herokuapp.com/#/home' target="_blank">Image Bunker</a>, An Instagram-like website where users can upload images and comment on other users' images.
            <a href='http://track-share.herokuapp.com/welcome/#/' target="_blank">
              <br/>Track#Share</a>, Social Network where users can register/login, befriend other users, see who's online and exchange song suggestions on the community chat.
            ...
            <a href='https://github.com/Johnnybar/mini-projects/tree/master/GithubApiSearch' target="_blank"><br/>
              GitSearch.</a>, a mini-app, designed to search for GitHub users and view their most recent commits.
            <br/>
