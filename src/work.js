        ...
        return(
            <div id='work-section'>
                ...
                <div className = "wrapper" >
                    ...
                    <div className='box-text spotifyui'>A mini-Spotify UI to search for and play music from albums and artists. Click <a href='https://github.com/Johnnybar/mini-projects/tree/master/spotifyApiSearch'>here</a> to see source code</div>
                        <img className="big-box f" src='./gitsearch.png'/>
                    <div className='box-text gitsearch'>A mini-app, designed to search for GitHub users and view their most recent commits. Click <a href='https://github.com/Johnnybar/mini-projects/tree/master/GithubApiSearch'>here</a> to see source code</div>
