    ...
    render(){
        return(
            <div id='work-section'>
                ...
                <div className='work-description'><p> <a href='https://github.com/Johnnybar/imageboard' target="_blank">Image Bunker</a>, An Instagram-like website where users can upload images and comment on other users' images.
                <a href='https://github.com/Johnnybar/social-network' target="_blank"> <br/>Track#Share</a>,  Social Network where users can register/login, befriend other users, see who's online and exchange song suggestions on the community chat.
                <a href='https://github.com/Johnnybar/petition'> Save The Drop Bear</a>, an online petition allowing users to register, manage a profile, sign a petition and see signers.
                 <a href='https://github.com/Johnnybar/english-showtimes-berlin' target="_blank"> English Showtimes Berlin</a>, a website that allows users to view cinemas that play non-dubbed movies in Berlin, check the current program using an API,
                ...
                <a href='https://github.com/Johnnybar/mini-projects/tree/master/GithubApiSearch' target="_blank"> GitSearch.</a>, a mini-app, designed to search for GitHub users and view their most recent commits.
             </p>
                </div>
                </div>
