        ...
        return(
            <div id='work-section'>
                ...
                <a href='https://j-petition.herokuapp.com/register'> Save The Drop Bear</a>, an online petition allowing users to register, manage a profile, sign a petition and see signers.
                 <a href='http://english-showtimes-berlin.herokuapp.com' target="_blank"> English Showtimes Berlin</a>, a website that allows users to view cinemas that play non-dubbed movies in Berlin, check the current program using an API,
