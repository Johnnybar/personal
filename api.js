...
exports.getSpotifyAuthCode = function() {
  ...
  return request.get('https://accounts.spotify.com/authorize' + '?response_type=code' + '&client_id=' + '31cc8672a5c14cf394b42ed47dd5347d' + (
    scopes
    ? '&scope=' + encodeURIComponent(scopes)
    : '') + '&redirect_uri=' + encodeURIComponent('https://localhost:8080/try')).then((results) => {
